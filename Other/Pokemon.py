...
pokeP1= image.load("pokeP1.jpg").convert()
pokeP1 = transform.scale(pokeP1,(1024,768))
pokeP2 = image.load("pokeP2.jpg").convert()
...
extras = image.load("extras.jpg").convert()
extras = transform.scale(extras,(1024,768))
Stats1 = image.load("Stats1.jpg").convert()
Stats2 = image.load("Stats2.jpg").convert()
typechart = image.load("typechart.jpg").convert()
areyousure = image.load("areyousure.jpg").convert()
intro_song = mixer.music.load("intro_song.mp3")
...
##    intro_song = mixer.music.set_volume(0)
...
##        if health >= 60:
##            health = 60
##        draw.rect(screen,(255,0,0),(80-health,20,health,10))
##        time.wait(50)
...
#--------------------------------------------------------Charizard------------------------------------------    
        if player_1 == "charizard":
            charizardP1 = image.load("Charizard_Moves.jpg").convert()
...
#--------------------------------------------------------Blastoise------------------------------------------
        if player_1 == "blastoise":
            blastoiseP1 = image.load("Blastoise_Moves.jpg").convert()
...
#--------------------------------------------------------Ho-Oh------------------------------------------
        if player_1 == "hooh":
            hoohP1 = image.load("Ho-oh_Moves.jpg").convert()
...
#--------------------------------------------------------Lugia------------------------------------------
        if player_1 == "lugia":
            lugiaP1 = image.load("Lugia_Moves.jpg").convert()
...
#--------------------------------------------------------Pikachu------------------------------------------
        if player_1 == "pikachu":
            pikachuP1 = image.load("Pikachu_Moves.jpg").convert()
...
#--------------------------------------------------------Venusaur------------------------------------------
        if player_1 == "venusaur":
            venusaurP1 = image.load("Venusaur_Moves.jpg").convert()
...
#--------------------------------------------------------Charizard------------------------------------------    
        if player_2 == "charizard":
            charizardP2 = image.load("Charizard_Moves.jpg").convert()
...
#--------------------------------------------------------Blastoise------------------------------------------
        if player_2 == "blastoise":
            blastoiseP2 = image.load("Blastoise_Moves.jpg").convert()
...
#--------------------------------------------------------Ho-Oh------------------------------------------
        if player_2 == "hooh":
            hoohP2 = image.load("Ho-oh_Moves.jpg").convert()
...
#--------------------------------------------------------Lugia------------------------------------------
        if player_2 == "lugia":
            lugiaP2 = image.load("Lugia_Moves.jpg").convert()
...
#--------------------------------------------------------Pikachu------------------------------------------
        if player_2 == "pikachu":
            pikachuP2 = image.load("Pikachu_Moves.jpg").convert()
...
#--------------------------------------------------------Venusaur------------------------------------------
        if player_2 == "venusaur":
            venusaurP2 = image.load("Venusaur_Moves.jpg").convert()
